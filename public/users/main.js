  ...
  loginForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Save Client Data
        localStorage.setItem("clientId", data.client.clientId);
        localStorage.setItem("clientName", data.client.fullName);
